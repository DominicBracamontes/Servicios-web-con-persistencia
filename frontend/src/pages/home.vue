            ...
            <v-card class="h-100 d-flex flex-column" flat>
              ...
              <v-card-text class="flex-grow-1 pa-4" style="overflow-y: auto;">
                <div style="max-width: 800px; margin: 0 auto;">
                  <p class="text-body-1 mb-4">Esta página web gestiona estudiantes, docentes y asignaturas de forma centralizada, facilitando matrículas, semestres y calificaciones. Ideal para instituciones educativas que buscan optimizar su administración académica.</p>
                </div>
              </v-card-text>
            </v-card>
          </v-col>
