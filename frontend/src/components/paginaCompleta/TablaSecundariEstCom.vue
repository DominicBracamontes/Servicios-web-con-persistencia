  ...
  <v-card>
    ...
    <v-card-text>
      <v-form @submit.prevent="confirmEdit">
        <v-text-field
          v-model="editForm.nuevaClaveAsignatura"
          label="Nueva Clave de Asignatura"
          required
        />
        <v-text-field
          v-model="editForm.nuevoSemestre"
          label="Nuevo Semestre (ej. 20241)"
          required
        />
        <v-text-field
          v-model="editForm.nuevaCalificacion"
  ...
  <v-card>
    ...
    <v-card-text>
      <v-form @submit.prevent="confirmPatch">
        <v-text-field
          v-model="patchForm.nuevaClaveAsignatura"
          label="Clave de Asignatura"
          required
        />
        <v-text-field
          v-model="patchForm.nuevaCalificacion"
          label="Calificación"
          type="number"
          required
        />
