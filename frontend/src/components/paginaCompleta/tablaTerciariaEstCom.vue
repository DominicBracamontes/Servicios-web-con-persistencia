<template>
  <div>
    <div class="d-flex justify-end mb-2">
      <!--BOTON-->
      <v-btn color="primary" @click="fetchInscripciones(matricula)" :disabled="loading" prepend-icon="mdi-refresh">
        Recargar
      </v-btn>
    </div>

    <!--TABLA-->
    <v-data-table :headers="headers" :items="docentesPorAsignatura" :loading="loading" hide-default-footer
